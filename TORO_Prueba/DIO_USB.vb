Module DIO_USB
    ...
    Public Function LeerConfigDIO() As Boolean
        ...
        cmd.CommandText = "SELECT Board_Num, Etiqueta_Ancho, Etiqueta_Largo FROM DIO_Config"
        Try
            conn.Open()
            Try
    ...
    Public Function Guardar_Board_Number(ByVal Num As String) As Boolean
        ...
        conn.Close()
    End Function
    Public Function Guardar_Label_Lab(ByVal Ancho As String, ByVal Largo As String) As Boolean
        conn.Close()
        conn.Open()
        cmd.Connection = conn
        cmd.CommandType = CommandType.Text

        sql = "Update DIO_Config set Etiqueta_Ancho='" & Ancho & "',Etiqueta_Largo='" & Largo & "'"
        cmd.CommandText = sql
        Try
            cmd.ExecuteNonQuery()
        Catch ex As Exception
