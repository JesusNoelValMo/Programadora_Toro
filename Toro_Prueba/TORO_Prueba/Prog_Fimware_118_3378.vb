Module Prog_Fimware_118_3378
    ...
    Public Function Programar_Firmware_118_3378(ByVal Firmware_Bit As Integer) As Boolean
        tiempo = 0
        ...
        While (1)
            ...
            If Modelo = "118-2919" Then
                ...
                If tiempo2 > (Timeout_Firmware * 10) + 30 Then
                    ' MsgBox("Falla Firmware")
                    Encendido = 0
                    USB_OFF = 0
